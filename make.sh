...
if [[ "${DOC}" == "1" ]]; then
  if [[ -x "$(command -v help2man)" ]]; then
    ...
    help2man -n "proton chat" -N -o src/proton.1 ./build/bin/proton && ${SED} "s/\.\\\\\" DO NOT MODIFY THIS FILE\!  It was generated by help2man.*/\.\\\\\" DO NOT MODIFY THIS FILE\!  It was generated by help2man./g" src/proton.1 || exiterr "doc failed, exiting."
  fi
fi
